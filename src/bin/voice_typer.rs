...
Prisma, PostgreSQL, Redis, JSON, REST, GraphQL, WebSocket, OAuth, JWT, regex, localhost, endpoint, webhook, cron, tmux, worktree, subagent, баг-репорт.";
...
fn run_openai(
    ...
    let vad: Arc<Mutex<VadPhraseDetector>> = Arc::new(Mutex::new(VadPhraseDetector::new(RECORDING_SAMPLE_RATE)));
